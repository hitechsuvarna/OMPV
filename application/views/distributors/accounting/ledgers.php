	    ...
	    <table id="products">
            ...
            <tbody>
                <?php for($i=0; $i<count($ledgers);$i++) {
                    echo '<tr id="'.$ledgers[$i]->iacl_id.'"><td>'.$ledgers[$i]->iacl_name.'</td></tr>';    
                }
                ?>
...
<script>
	$(document).ready(function() {
	    $('#fixed-header-drawer-exp').keyup(function(e) {
            $.post('<?php echo base_url().$type."/Accounting/search_ledgers"; ?>', {
                'keywords' : $(this).val()
        ...
        $('#submit').click(function(e) {
            ...
            window.location = "<?php echo base_url().$type.'/Accounting/add_ledger'; ?>";
        });
