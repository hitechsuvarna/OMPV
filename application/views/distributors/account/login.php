			...
			'
				...
				<div class="mdl-cell mdl-cell--4-col" style="text-align: center;">
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<label class="mdl-textfield__label" for="u_name">Email Address</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
					...
					<button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--colored" id="forgot">
						Forgot Password?
					</button>
...
<script>
	...
	$(document).ready(function() {
	    ...
	    $('#forgot').click(function(e) {
	        e.preventDefault();
	        window.location = '<?php echo base_url().$type."/Account/forgot_password/".$oid; ?>';
	    })
	...
	function submitdata() {
		...
		$.post('<?php echo base_url().$type."/Account/verify"; ?>', {
			...
			console.log(data); 
			if(data == 'true') { 
				window.location = '<?php echo base_url().$type."/Home"; ?>'; 
			} else if(data == "false") { 
				var ert = {
				...
				var ert = {
					message: 'Your Account has been Blocked. Kindly contact admin',timeout: 2000,
				};
				snackbarContainer.MaterialSnackbar.showSnackbar(ert); 
			}  else {
